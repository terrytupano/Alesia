...
public class JCTextField extends JTextField implements Serializable {
	...
	protected void paintComponent(Graphics g) {
		...
		g2.fillRoundRect(1, 1, getWidth() - 2, getHeight() - 2, roundness, roundness);
		if (drawShadow) {
			g2.setColor(shadowColor1);
			g2.drawRoundRect(1, 1, getWidth() - 3, getHeight() - 2, roundness, roundness);

			g2.setColor(shadowColor2);
			g2.drawRoundRect(1, 2, getWidth() - 3, getHeight() - 4, roundness, roundness);
		}
	...
	/**
	 * Shadow is emulated drawing two lines with light colors below the top border.
	 *
	...
	/**
	 * The roundness is the width and height in pixels of the arc in this component's corners.
	 *
	 * @param roundness
	 */
	...
	/**
	 * This funtion does nothing and should not be used. JTextField is allways non opaque.
	 */
	@Override
	...
	/**
	 * This funtion should not be used. You can change the border color with setBorderColor(), and shadows with
	 * setShadowColors();
	 */
	@Override
