	...
	private void initialize() 
	{
		...
		btnAa.addMouseListener(new MouseAdapter() {
			...
			public void mousePressed(MouseEvent e) {
				...
				lblXx.setText(selectedHand); evaluate();
			}
		});
		...
		btnAqs.addMouseListener(new MouseAdapter() {
			@Override
			public void mousePressed(MouseEvent e) {selectedHand = getHandFromButtonEvent(e);
				lblXx.setText(selectedHand); evaluate();
			}
		});
		...
		lblPlayersBehind.setToolTipText("The number of players left to act after you (e.g. If  you are in SB, there is 1 player behind you (BB))");
		...
		radioButton_players_8.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {evaluate();
			}
		});
		...
		radioButton_players_7.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {evaluate();
			}
		});
