 ...
 * <br />
 * 
 * Each pot has an equal fixed amount for all contributing players. In case of a partial call, bet or raise, the pot
 * must be {@link #split}.
 * 
...
public class Pot {
	...
	/**
	 * In case of a partial call, bet or raise, splits this pot into two pots, with this pot keeping the lower bet and
	 * the other pot the remainder.
	 * 
