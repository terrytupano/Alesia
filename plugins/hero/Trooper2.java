...
public class Trooper2 extends Task {
	...
	public Trooper2(SensorsArray array, PokerSimulator pokerSimulator) {
...
//			rnk = Integer.parseInt(prank.get(0));
	...
	private void setPreflopActions() {
		...
		String txt1 = "Preflop hand in range " + twoDigitFormat.format(base) + " + (" + twoDigitFormat.format(bBlind)
