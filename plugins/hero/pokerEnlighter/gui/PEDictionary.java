...
{    
    ...
    private static final String dictionaryEN = "plugins/hero/pokerEnlighter/resources/config/dict.en";
    private static final String dictionaryRO = "plugins/hero/pokerEnlighter/resources/config/dict.ro";
