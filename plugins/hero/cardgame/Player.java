...
public class Player implements Comparable<Player> {
	...
	public static enum OpenCheck {
		OPEN, CHECK
	};
	public static enum CallRaiseFold {
		CALL, RAISE, FOLD
	};
	private String name;
	private Game game;
	...
	public void dealCard(final UoACard card) {
		cards.add(card);
	}

	public void removeCard(final UoACard card) {
		cards.remove(UoACard);
	}

	public void disUoACardCards() {
		cards.clear();
		bet = 0;
		hasFolded = false;
		isOut = cash <= 0;
