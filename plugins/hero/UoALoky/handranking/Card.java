 ...
 */
package plugins.hero.UoALoky.handranking;

import plugins.hero.UoALoky.handranking.util.*;
...
public class Card implements Comparable<Card> {
	...
	public static final int[] ALL_SUITS = {SUIT_CLUBS, SUIT_DIAMONDS, SUIT_HEARTS, SUIT_SPADES};
	...
	public static final int[] ALL_RANKS = {RANK_2, RANK_3, RANK_4, RANK_5, RANK_6, RANK_7, RANK_8, RANK_9, RANK_10,
	...
	public boolean equals(Object obj) {
		...
		return otherCard.getSuit() == this.suit && otherCard.getRank() == this.rank;
	}
