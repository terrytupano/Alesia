 ...
 */
public interface TUser32 extends StdCallLibrary, WinUser, WinNT {

    /** The instance. */
    TUser32 INSTANCE = (TUser32) Native.loadLibrary("user32", TUser32.class, W32APIOptions.DEFAULT_OPTIONS);
     ...
     */
    short VkKeyScanExW(char ch, HKEY dwhkl);
