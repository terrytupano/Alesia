...
/**
 * The SmartScroller will attempt to keep the viewport positioned based on the users interaction with the scrollbar. The
 * normal behaviour is to keep the viewport positioned to see new data as it is dynamically added.
 *
 ...
 *
 * - when the viewport is at the top and new data is added, then do nothing with the viewport - when the viewport is not
...
public class SmartScroller implements AdjustmentListener {
	 ...
	 * @param viewportPosition indicates where the viewport will normally be positioned as data is added. Valid values
	 *        are START and END
	 */
