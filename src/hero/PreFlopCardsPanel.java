...
public class PreFlopCardsPanel extends TUIPanel {
	 ...
	 */
	public TSEntry getSelectedRange() {
		return (TSEntry) preflopsComboBox.getSelectedItem();
	}
	...
	private void loadFromDB() {
		TSEntry entry = (TSEntry) preflopsComboBox.getSelectedItem();
		preflopCardsModel = new PreflopCardsModel(entry.getKey());
