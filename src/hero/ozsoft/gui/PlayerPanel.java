...
//		setBorder(BORDER);
		...
		card1Label = new JLabel(Constants.CARD_PLACEHOLDER_ICON);
		card2Label = new JLabel(Constants.CARD_PLACEHOLDER_ICON);
		dealerButton = new JLabel(Constants.BUTTON_ABSENT_ICON);
	...
	public void update(Player player) {
		...
		if (player.hasCards()) {
			...
			if (hand.size() == 2) {
				...
				card2Label.setIcon(Constants.CARD_BACK_ICON);
			}
		} else {
			// No cards.
			card1Label.setIcon(Constants.CARD_PLACEHOLDER_ICON);
			card2Label.setIcon(Constants.CARD_PLACEHOLDER_ICON);
		}
	}
	...
	public void setDealer(boolean isDealer) {
		if (isDealer) {
			dealerButton.setIcon(Constants.BUTTON_PRESENT_ICON);
		} else {
			dealerButton.setIcon(Constants.BUTTON_ABSENT_ICON);
		}
	}
