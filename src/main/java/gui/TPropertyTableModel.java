...
/**
 * implementacion de <code>AbstractTableModel</code> especificamente dise�ada para la edicion de lista de propiedades en
...
public class TPropertyTableModel extends AbstractTableModel {
	...
	private Vector<TSEntry> properties;
	 ...
	 */
	public TPropertyTableModel(Vector<TSEntry> prp) {
		this.properties = prp;
	}

	public void addProperty(TSEntry it) {
		properties.add(it);
	...
	public void setValueAt(Object aValue, int rowIndex, int columnIndex) {
		...
		TSEntry t = properties.elementAt(rowIndex);
		if (properties != null) {
			switch (columnIndex) {
				case 1 :
