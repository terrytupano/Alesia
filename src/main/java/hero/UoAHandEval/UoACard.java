...
public class UoACard {
    ...
    */
   public UoACard(int rank, int suit) {
    ...
    */
   public UoACard(char rank, char suit) {
   ...
   public boolean equals(Object o) {
      if (!(o instanceof UoACard))
         return false;

      UoACard other = (UoACard) o;
