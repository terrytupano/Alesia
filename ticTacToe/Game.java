...
/**
 * This is a class that defines the environment of a Tic Tac Toe Game: its underlying state representation, actions
 * transitions etc. It also provides functionality for playing out a game between two agents, various other useful
 * methods.
 * 
 * 
 * 
...
public class Game {
	...
	/**
	 * this integer represents the state of the game, and is set by {@link #evaluateGameState()} after every move DO NOT
	 * CONFUSE THIS with an MDP state.
	 */
	int state = 0;
	...
	/**
	 * 
	 * @return All possible next game states from the current game state in one step where the agent whose turn it is
	 *         moves.
	 * 
	 */
	...
	/**
	 * A static method to generate all valid game states where it is either X's turn or O's turn as specified by
	 * {@code xo} argument. NOTE: this method will include ALL terminal states in the game.
	 * 
	...
	public static List<Game> generateAllValidGames(char xo) {
		List<Game> result = new ArrayList<Game>();
		// this is the number of possible game hashes (2222222222 in base 3): 59048 - not all are valid. Here we only
	...
	/**
	 * This method will play out the game to the end using moves from the X and O agents. Use this method to test your
	 * agents
	 * 
	...
	/**
	 * A hashCode function implemented assuming the game board is a 10 digit number in base three, where: ' ' maps to 0
	 * 'X' maps to 1 'O' maps to 2
	 * 
	 ...
	 * 
	 * @param a
	 * @throws throws IllegalMoveException of the there is an illegal move by one of the agents. This would just exit
	 *         the programme.
	 */
